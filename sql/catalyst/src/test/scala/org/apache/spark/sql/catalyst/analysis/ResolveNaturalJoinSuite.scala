...
class ResolveNaturalJoinSuite extends AnalysisTest {
  ...
  test("natural/using inner join") {
    ...
    val usingPlan = r1.join(r2, Inner, Some(UnresolvedUsingAttributes(Seq("a"))))
  ...
  test("natural/using left join") {
    ...
    val usingPlan = r1.join(r2, LeftOuter, Some(UnresolvedUsingAttributes(Seq("a"))))
  ...
  test("natural/using right join") {
    ...
    val usingPlan = r1.join(r2, RightOuter, Some(UnresolvedUsingAttributes(Seq("a"))))
  ...
  test("natural/using full outer join") {
    ...
    val usingPlan = r1.join(r2, FullOuter, Some(UnresolvedUsingAttributes(Seq("a"))))
  ...
  test("natural/using inner join with no nullability") {
    ...
    val usingPlan = r3.join(r4, Inner, Some(UnresolvedUsingAttributes(Seq("b"))))
  ...
  test("natural/using left join with no nullability") {
    ...
    val usingPlan = r3.join(r4, LeftOuter, Some(UnresolvedUsingAttributes(Seq("b"))))
  ...
  test("natural/using right join with no nullability") {
    ...
    val usingPlan = r3.join(r4, RightOuter, Some(UnresolvedUsingAttributes(Seq("b"))))
  ...
  test("natural/using full outer join with no nullability") {
    ...
    val usingPlan = r3.join(r4, FullOuter, Some(UnresolvedUsingAttributes(Seq("b"))))
